...
**0.62%** aggregate error / 45.9% of rows exact on the 567 `fixed` rows,
13.0% / 31.2% on the 16 `spread` ones and 22.2% / 61.8% on the 55
`unestablished` ones (1.23% pooled over 638): `spread` — a demo whose own
