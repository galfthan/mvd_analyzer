...
| 14 | **NEXT** — API keys: `internal/authkeys` store, auth middleware, per-key rate limiting (closes api F15's limit half), `keys` CLI, `/v1/auth/check`. [PLAN-hosting.md](PLAN-hosting.md) |
